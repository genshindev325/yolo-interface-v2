...
export const WalletSelectorModal = ({ closeModal, fullConnection }) => {
  ...
  return (
    <ModalOverlay>
      <Modal id='wallet_selector_modal'>
        <CloseBotton name='close2' mask onClick={closeModal} />
        <ModalTitle variant='caption' size='1.4' weight='600'>
          Connect to a Wallet
        </ModalTitle>
        <WalletSelector onSelect={onWalletSelect} fullConnection={fullConnection} />
      </Modal>
    </ModalOverlay>
  )
}
